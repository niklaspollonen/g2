...
#define INIT_MESSAGE "Initializing configs to proxxon MF70 GAUPS 1.1"
...
#define M1_TRAVEL_PER_REV           1                  // 1tr
...
#define JERK_MAX                    120
#define SEARCH_VELOCITY             120
#define LATCH_BACKOFF               50

#define X_AXIS_MODE                 AXIS_STANDARD           // xam  see canonical_machine.h cmAxisMode for valid values
#define X_VELOCITY_MAX              JERK_MAX                   // xvm  G0 max velocity in mm/min
#define X_FEEDRATE_MAX              X_VELOCITY_MAX          // xfr  G1 max feed rate in mm/min
#define X_TRAVEL_MIN                0                       // xtn  minimum travel for soft limits
#define X_TRAVEL_MAX                128                     // xtm  travel between switches or crashes
